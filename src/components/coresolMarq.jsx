...
function CoresolMarq() {
  const items = [
    ...
    { video: "/assets/videos/1.mp4", text: "Premium Fabrics", link: "#" },
    { video: "/assets/videos/1.mp4", text: "Sustainable Living" },
    { video: "/assets/videos/1.mp4", text: "Eco-Friendly Choice" },
    { video: "/assets/videos/1.mp4", text: "Modern Design" },
    { video: "/assets/videos/1.mp4", text: "Comfort First" },
    { video: "/assets/videos/1.mp4", text: "Ethical Fashion" },
    { video: "/assets/videos/1.mp4", text: "Natural Materials" },
